...
def test_json_prefix_preserved() -> None:
    ...
    `{\"name\":\"` was eaten."""
    from ufal_mcp.maskit_parsing import _MASKIT_PLACEHOLDER, parse_maskit
...
def test_sql_prefix_preserved() -> None:
    from ufal_mcp.maskit_parsing import parse_maskit
...
def test_maskit_placeholder_bracket_format() -> None:
    ...
    from ufal_mcp.maskit_parsing import _MASKIT_PLACEHOLDER
